const Faq = () => {
  return (
    <div className="documentation-page">
      <h1 className="text-top my-5 font-weight-bold"><u>Frequently Asked Questions:</u></h1>
                  ...
                  <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                    <div className="accordion-body">
                      <ol type="A">
                        ...
                        <li>Securely stores the private key in the user Metamask wallet.</li>
                      </ol>
                    </div>
                  </div>
                </div>
                  ...
                  <div id="collapseFive" className="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                    <div className="accordion-body">
                      <ol type="A">
                        ...
                        <li>Digital signature is verified against the user public key on the blockchain.</li>
                  ...
                  <div id="collapseTwelve" className="accordion-collapse collapse" aria-labelledby="headingTwelve" data-bs-parent="#additionalFaqAccordion">
                    <div className="accordion-body">
                      <ul>
                        ...
                        <li>Ensures data privacy by securely storing private keys in the user Metamask wallet.</li>
                      </ul>
                    </div>
                  </div>
                </div>
